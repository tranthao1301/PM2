...
public class VerleihServiceImplTest
{
    ...
    {
    	assertTrue(_verleihService.istVerleihenMoeglich(_homer, _medienbestand.getMedien()));
    	_verleihService.verleiheAn(_homer, _medienbestand.getMedien(), Datum.heute());
    	assertFalse(_verleihService.istVerleihenMoeglich(_homer, _medienbestand.getMedien()));
